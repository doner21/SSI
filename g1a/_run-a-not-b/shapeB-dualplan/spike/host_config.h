...
// ── B-specific locked defaults (PRE-REG §4) ─────────────────────
constexpr double MOD_INDEX = 1.0;   // FM2op modulation index
constexpr double RATIO     = 1.0;   // FM2op modulator:carrier freq ratio
