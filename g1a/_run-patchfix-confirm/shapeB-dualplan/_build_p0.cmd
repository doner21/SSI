...
cl.exe /std:c++17 /EHsc /O2 /DCMAJOR_DLL=1 ^
  ...
  variantP0\p0_main.cpp variantP0\engine_setup.cpp variantP0\event_schedule.cpp variantP0\metrics.cpp variantP0\proof.cpp > build_P0_normal.log 2>&1
set RC=%ERRORLEVEL%
echo [compile_P0] exit=%RC%
