// src-v2/prng.ts — G1B Falsifier v2 deterministic seeding (HARNESS-SPEC-v2 §4 / PRE-REG-v2 §7.3).
//
// IDENTICAL to v1 (g1b/src/prng.ts) — the only v2 difference is the MASTER CONSTANT, which is
// NOT baked into this module: `seedMaster` is passed in as a parameter (from CONFIG, §4.1/§A.0),
// so the splittable PRNG code itself is carried VERBATIM from v1. v2 is seeded by the new master
// SEED_MASTER = 0x5551B_0002 (registered in src-v2/config.ts), distinct from v1's 0x5551B_0001.
//
...
// SEED_MASTER = 0x5551B_0002 (§7.3, v2). NO `Math.random` anywhere — all randomness flows
